#
#  Be sure to run `pod spec lint JFOpenWeatherMapManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Jonathan Field" => "jonfield@me.com", "other author" => "email@address.com" }
  # s.author           = 'Jonathan Field', 'other author'
  ...
  s.source       = { :git => "https://github.com/jfield44/JFOpenWeatherMapManagerCocoaPods", :tag => "1.0.0" }
